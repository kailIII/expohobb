<?php 
	...
	$mail->Subject = "Expohobby Validacion de e-mail"; 
	...
	if(!$mail->Send()){ 
		...
		$guardar = "INSERT INTO usuarioe (id, nombre, apellido, dni, email, info, codigo, codigoC ) VALUES (  null, '$nombre', '$apellido', '$dni', '$email', $info, '$codigo', '$codigoC')";
		mysql_query( $guardar ,  $exp);
		header( 'Location:entradas.php?b=1' );
	} 
?>