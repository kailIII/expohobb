            ...
            <section class="secexpo">
                  ...
                  <div class="cont-descrpexp">
                     ...
                     <ul class="optdes_expo">
                        ...
                        <li><a href="#modal_confirmation_entradas" id="seleccion2"  class="seleccionar_us">Acreditación</a></li>
   ...
   <script type="text/javascript">
                    jQuery(document).ready(function($) {
                        $("#seleccion1").click(function(){						
                   		$('#modal_confirmation_ver').html('<h3 class="cont_vermap">Cómo llegar a Titulo de la exposicion?</h3><iframe width="573" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com.ar/maps?f=q&amp;source=s_q&amp;hl=es&amp;geocode=&amp;q=Sarmiento+1867&amp;aq=&amp;sll=-34.614562,-58.428726&amp;sspn=0.019178,0.042014&amp;ie=UTF8&amp;hq=&amp;hnear=Sarmiento+1867,+San+Nicol%C3%A1s,+Buenos+Aires&amp;ll=-34.605704,-58.393192&amp;spn=0.002398,0.005252&amp;t=m&amp;z=14&amp;output=embed"></iframe><button class="mfp-close" type="button" title="Close (Esc)">×</button>');
                        });
						 $("#seleccion2").click(function(){						
                   		$('#modal_confirmation_ver').html('<h3 class="cont_vermap">Descarga el Cupón con descuento!</h3><div id="form_registro_email">Nombre<input  type="email" onBlur="" required="required"/>Apellido<input  type="email" onBlur="" required="required"/>Dni<input  type="email" onBlur="" required="required"/>mail<input  type="email" onBlur="" required="required"/>repetir mail<input  type="email" onBlur="" required="required"/><input id="btn_registrar_mail" class="btn-classic" type="submit" value="Enviar" name="btn_registrar_mail" /></div><button class="mfp-close" type="button" title="Close (Esc)">×</button>');
                        });
