<script>
	...
	<div id="contmag"  class="container">
        ...
        <!-- empieza hoja -->
            ...
            <!-- empieza hoja -->
                <div>
                	<span class='zoom ex1'><img src='<?php echo 'revista'.$revista['id'].'/pages/'; ?>07.jpg' alt='Expohobby Decodigital' width= '429' border="0" usemap="#Map"/>
                    <map name="Map" id="Map">
...
<area shape="rect" coords="18,168,362,296" href="http://www.libreriaedorado.com.ar/" target="_blank">
          ...
          <!-- empieza hoja -->
                <div>
                	<span class='zoom ex1'><img src='<?php echo 'revista'.$revista['id'].'/pages/'; ?>38.jpg' alt='Expohobby Decodigital' width= '429' border="0"/></span>
                </div>
            
          <!-- empieza hoja -->
                <div>
                	<span class='zoom ex1'><img src='<?php echo 'revista'.$revista['id'].'/pages/'; ?>39.jpg' alt='Expohobby Decodigital' width= '429' border="0"/></span>
                </div>
            
          <!-- empieza hoja -->
                <div>
                	<span class='zoom ex1'><img src='<?php echo 'revista'.$revista['id'].'/pages/'; ?>40.jpg' alt='Expohobby Decodigital' width= '429' border="0"/></span>
                </div>
